...
export const CATALOG_ITEMS: CatalogItem[] = [
  ...
  },
  {
    ...
    description: 'Suministro desde la red municipal de agua potable. Presión típica 2.5 kg/cm² (≈25 m).',
    category: 'almacenamiento',
    icon: IconHomeSignal,
    color: '#0284c7',
    defaults: {
  ...
  },
  {
    ...
    nodeType: 'reservoir',
    name: 'Pozo de Agua',
    description: 'Extracción de agua subterránea con presión limitada.',
    category: 'almacenamiento',
  ...
  },
  {
    ...
    element: 'node',
    nodeType: 'reservoir',
    name: 'Cisterna/Tanque Enterrado',
    description: 'Tanque de almacenamiento subterráneo con bomba de impulsión.',
    category: 'almacenamiento',
    icon: IconBucket,
    color: '#164e63',
    defaults: {
  ...
  },
  {
    ...
    element: 'node',
    nodeType: 'reservoir',
    name: 'Reservorio General',
    description: 'Fuente de presión constante genérica para otros casos.',
    category: 'almacenamiento',
